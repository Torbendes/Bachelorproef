...
zoals een dynamische rangschikking, recente vorm, eerdere onderlinge confrontaties, 
een speelstijlscore en indicatoren voor titel-, degradatie- en derbywedstrijden. 
Alle data werden opgeslagen in een relationele databank.
...
Tegelijkertijd hiermee werden zes voetbalexperts met een professionele achtergrond in het Belgische voetbal en de sportjournalistiek bevraagd via een enquête.
...
wat in lijn is met de waarden die in de internationale literatuur worden gerapporteerd voor voetbalvoorspellingen.

\vspace{5pt}

Voor doelpunten bleek de speelstijlcombinatie aanvallend versus verdedigend een statistisch significante
invloed (p = 0,0139). Voor kaarten werden enkel degradatiewedstrijden als significant bevonden (p = 0,0399).
...
terwijl de modellen gevoelig zijn voor temperatuur (mogelijk als seizoensgerelateerde externe variabele).
