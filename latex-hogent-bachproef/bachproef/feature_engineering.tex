...
\begin{table}[h]
\centering
\caption{Overzicht van gedefinieerde rivaliteitswedstrijden}
\label{tab:derby_pairs}
\begin{tabular}{ll}
\hline
\textbf{Thuisploeg} & \textbf{Uitploeg} \\
\hline
...
Hierbij werden het aantal doelpunten en schoten meegenomen.
