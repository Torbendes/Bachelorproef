...
tonen wel een statistisch significante associatie, maar de praktische voorspellende waarde blijft beperkt (38,29\% accuraatheid als enkel criterium).
...
Noch temperatuur, noch neerslag toont een statistisch significant effect op het aantal schoten, doelpunten of kaarten
in de uitgevoerde t-tests. Stadioncapaciteit vertoont een zwak maar statistisch significant verband
met het aantal overtredingen van het uitteam (r = 0,079, p < 0,001), wat mogelijk te verklaren is
door de hogere druk van een groot thuispubliek. Het tijdstip van de wedstrijd (avond versus dag, weekend versus weekdag)
...
worden geïdentificeerd. Voor het wedstrijdresultaat zijn dit form\_diff en rank\_diff. Voor doelpunten
domineren abs\_rank\_diff en temperatuur (als seizoensgebonden confounder). Voor schoten is de speelstijlcombinatie
de belangrijkste groep features. Voor kaarten neemt eveneens de speelstijlcombinatie de eerste plaats in.
...
als de richting en grootte van hun effect (SHAP) inzichtelijk weer.
...
--- een gevolg van schijnbare correlatie door seizoensgebonden effecten.
...
De intrinsieke onvoorspelbaarheid van voetbal blijft een fundamentele uitdaging.
...
\textbf{Opname van scheidsrechtersdata.} Het ontbreken van informatie over de leidende scheidsrechter
is vermoedelijk de meest bepalende lacune in het kaartenmodel. Toekomstig onderzoek dat de persoonlijke
...
Een toekomstige studie met een grotere en meer gediversifieerde groep, inclusief scouts, coaches en data-analisten
...
verbanden en modelprestaties overdraagbaar zijn naar andere competities met een ander competitieniveau,
zoals de Challenger Pro League of Europese topcompetities.
...
\textbf{Tijdsreeksmodellering.} Het expliciete modelleren van temporele afhankelijkheden, zoals het
verloop van de competitie doorheen het seizoen of de invloed van de speeldag, via tijdsreeksmodellen
kan seizoensgebonden invloeden beter aanpakken dan statische features zoals temperatuur.
